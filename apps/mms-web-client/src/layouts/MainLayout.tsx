...
const NavItem: Component<{ href: string; icon: Component; label: string }> = (props) => {
  return (
    <A
      href={props.href}
      class="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-white/5 rounded-xl transition-all duration-200"
      activeClass="bg-primary/10 text-primary-glow font-medium shadow-[0_0_15px_rgba(59,130,246,0.3)]"
    >
...
const Sidebar: Component = () => {
  return (
    <aside class="w-64 h-screen border-r border-glass-border bg-background/50 backdrop-blur-xl fixed left-0 top-0 flex flex-col z-50">
      <div class="p-6">
